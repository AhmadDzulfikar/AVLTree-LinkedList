...
public class TP1 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Q; i++) {
            currentQuery++; // Menandakan query saat ini
            ...
            if (query.equals("A")) {
                ...
                Pelanggan pelangganBaru = new Pelanggan(nextId++, UangDimiliki, KesabaranPelanggan, currentQuery);
                ...
                if (pelangganToko.containsKey(idPelanggan)) {
                    ...
                    int sisaKesabaran = pelangganPergi.KesabaranPelanggan - (currentQuery - pelangganPergi.queryMasuk);
    ...
    static class Pelanggan implements Comparable<Pelanggan> {
        ...
        int queryMasuk; // Query ke berapa pelanggan ini masuk
